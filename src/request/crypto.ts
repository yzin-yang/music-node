...
export const rsaEncrypt = (buffer: Uint8Array, key: KeyLike) => {
...
export const weapi = (object: string) => {
...
export const decrypt = (cipherBuffer: NodeJS.ArrayBufferView) => {
